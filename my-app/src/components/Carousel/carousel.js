            ...
            {index === 0 ? 
                <div className="col-md website">
                    ...
                    <p>
                        ...
                        <a onClick={() => {
                            window.open("https://gerardo-abaunza-portfolio-v1.netlify.app/", "_blank");
            ...
            {index === 1 ? 
                <div className="col-md website">
                    ...
                    <p>
                        ...
                        <a onClick={() => {
                            window.open("https://gerardo-abaunza-portfolio-v2.netlify.app/", "_blank");
                        }}>Click here to visit the second version</a>
                    </p>
                </div>: ''}
            {index === 2 ? 
                <div className="col-md website">
                    ...
                    <p>
                        Ever since the last version, I learned React and Hooks 
                        so I decided to update my portfolio again to showcase React. Key differences between version 2 and version 3 is how version 3 was made in React
                        ...
                        <a onClick={() => {
                            window.open("https://gerardo-abaunza-portfolio-v3.netlify.app/", "_blank");
                        }}>Click here to visit the third version</a>
                    </p>
                </div>: ''}
            {index === 3 ? 
                <div className="col-md website">
                    ...
                    <p>
                        ...
                        better design (including better mobile compatability) and with updated information about my university courses and projects. 
                        I also changed the navbar design to highlight the use of props and states in React. Key differences between version 3 and version 4 is how the styling 
                        the styling in this version due to better use of bootstrap and updated information.
                    </p>
                </div>: ''}
        </div>
    )
