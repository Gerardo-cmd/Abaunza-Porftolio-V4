    ...
    return (
        <div className="row" id="page">
            <div>
                ...
                <div className="projects row" id="main-content">
                    <div className="col-1"></div>
                        <div className="container col-10">
                            ...
                            <div className="row" id = "Hangman">
                                <div className="col-lg">
                                    <img className="project d-block w-100 show" src={hangman} />
                                </div>
                                <div className="col-lg">
                                    <h2>Hangman App</h2>
                            ...
                            <div className="row" id = "Todo App">
                                ...
                                <div className="col-sm">
                                    <img className="project d-block w-100 show" src={todo}></img>
                                </div>
                            </div>
                            <br />
                            <br />
                            <div className="row" id = "Notes App">
                                <div className="col-lg">
                                    <img className="project d-block w-100 show" src={notes}></img>
                                </div>
                                <div className="col-lg">
                                    <h2>Notes App</h2>
                            ...
                            <div className="row" id = "Weather App">
                                ...
                                <div className="col-lg">
                                    <img className="project d-block w-100 show" src={weather}></img>
                                </div>
                            </div>
                            <br />
                            <br />
                            <div className="row" id = "Recipe App">
                                <div className="col-lg">
                                    <img className="project d-block w-100 show" src={recipe}></img>
                                </div>
                                <div className="col-lg">
                                    <h2>Recipe App</h2>
                                    <p>
