                ...
                <div className="container">
                    ...
                    <div className="row" id = "Hangman">
                        <div className="col-lg">
                            <img className="project d-block w-75 show" src={hangman} />
                        </div>
                        <div className="col-lg">
                            <h2>Hangman App</h2>
                    ...
                    <div className="row" id = "Todo App">
                        ...
                        <div className="col-sm">
                            <img className="project d-block w-75 show" src={todo}></img>
                        </div>
                    </div>
                    <br />
                    <br />
                    <div className="row" id = "Notes App">
                        <div className="col-lg">
                            <img className="project d-block w-75 show" src={notes}></img>
                        </div>
                        <div className="col-lg">
                            <h2>Notes App</h2>
                    ...
                    <div className="row" id = "Weather App">
                        ...
                        <div className="col-lg">
                            <img className="project d-block w-75 show" src={weather}></img>
                        </div>
                    </div>
                    <br />
                    <br />
                    <div className="row" id = "Recipe App">
                        <div className="col-lg">
                            <img className="project d-block w-75 show" src={recipe}></img>
                        </div>
                        <div className="col-lg">
                            <h2>Recipe App</h2>
                            <p>
